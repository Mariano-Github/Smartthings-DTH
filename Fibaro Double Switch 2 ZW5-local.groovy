 ...
 */
metadata {
  // Modified for local execution feb 2021 by Mariano  Colmenarejo
    ...
    definition (name: "Fibaro Double Switch 2 ZW5-local", namespace: "FibarGroup", author: "Fibar Group", mnmn: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, vid:"generic-switch-power-energy") {
		capability "Switch"
