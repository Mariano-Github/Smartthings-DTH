...
metadata {
    definition(name: "SmartSense Button+TimeRep+TempChangeRep", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.022.0000', executeCommandsLocally: false, mnmn: "SmartThings", vid: "SmartThings-smartthings-SmartSense_Button", ocfDeviceType: "x.com.st.d.remotecontroller") {
    ...
    tiles(scale: 2) {
        ...
        details(["button", "temperature", "battery", "refresh", "configure"])
    }
}
