...
metadata {
	definition(name: "SmartSense Motion Sensor-MCC", namespace: "smartthings", author: "SmartThings-mod MCC", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-motion", genericHandler: "Zigbee") {
...
def configure() {
	...
	if (isFrientSensor()) {
		...
		configCmds += zigbee.temperatureConfig(30, TempReportTimeMax)
	}
