 ...
 *  Modified By Mariano Colmenarejo Feb 2021 for Configuration of temperature and humidity reports
 */
import physicalgraph.zigbee.zcl.DataType

metadata {
	definition(name: "SmartSense Temp/Humidity Sensor-Config", namespace: "smartthings", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, ocfDeviceType: "oic.d.thermostat") {
...
def configure() {
	...
	// temperature minReportTime 30 seconds, maxReportTime 5 min. Reporting interval if no activity (modified to adjusted with settings variables Feb 2021)
	// battery minReport 30 seconds, maxReportTime 6 hrs by default
    def tempTime = TempReportTimeMax ? TempReportTimeMax : 5
