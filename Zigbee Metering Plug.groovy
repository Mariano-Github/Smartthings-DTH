...
metadata {
    definition (name: "Zigbee Metering Plug", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings",  vid: "generic-switch-power-energy") {
        ...
        fingerprint profileId: "0104", deviceId: "0009", inClusters: "0000, 0003, 0004, 0005, 0006, 0B04", outClusters: "0019", manufacturer: "NET2GRID", model: "SP31",  deviceJoinName: "NET2GRID Outlet" //Smart Plug
