...
metadata {
	definition (name: "Zigbee Smoke Sensor-MCC", namespace: "smartthings", author: "SmartThings MOD by Mcc", ocfDeviceType: "x.com.st.d.sensor.smoke", vid: "generic-smoke", genericHandler: "Zigbee") {
